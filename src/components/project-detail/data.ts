import type { BSystemNeedCard, Frame, ImageLayer } from "./types";

const S = "/assets/slices";

export const bSpecRects = [
...
export const moveArrow: ImageLayer = {
  src: `${S}/4214_1.png`,
  x: 1670.17,
  y: 752.34,
  w: 58.832,
...
export const appGalleryImageSources = new Set<string>(appGalleryCards.map((card) => card.src));
export const bSystemNeedAvatarSources = new Set([
  `${S}/Ellipse 1053.png`,
  `${S}/Ellipse 1054.png`,
  `${S}/Ellipse 1055.png`,
  `${S}/Ellipse 1056.png`,
...
export const bSystemNeedRows: BSystemNeedCard[][] = [
  [
...
export const bSystemFrames: Frame[] = [
  {
    height: 9211,
    hero: {
      title: "B端设计",
...
export const graphicFrames: Frame[] = [
  {
    height: 9833,
    background: "#070709",
    hero: {
...
export const framesBySlug: Record<string, Frame[]> = {
