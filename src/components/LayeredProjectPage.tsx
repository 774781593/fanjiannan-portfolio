...
const graphicFrames: Frame[] = [
  {
    ...
    images: [
      ...
      { src: `${S}/duanwu-sothis-2026.png`, x: 235, y: 5611, w: 617, h: 871 },
    ...
    texts: [
      ...
      { text: "SOTHIS\n端午节节日海报设计", parts: [{ text: "SOTHIS\n", color: "#666666", weight: 305 }, { text: "端午节节日海报设计", color: "#333333", weight: 630 }], x: 985, y: 5715, width: 432, size: 48, weight: 305, color: "#333333", family: "MiSans" },
      ...
      { text: "海报以浅宣纸肌理为底，结合东方书法与端午民俗意象，以大字“粽”为视觉核心，将龙舟、粽子、艾草与水纹自然融入笔画之中，体现传统文化的传承与节日仪式感。整体采用雅致清新的配色，并融入品牌logo，使节庆氛围与品牌气质统一，呈现出精致、温润且富有文化韵味的视觉表达。", x: 987, y: 6186, width: 698, height: 206, size: 20, weight: 305, color: "#333333", family: "MiSans" },
